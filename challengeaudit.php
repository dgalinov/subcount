    ...
    <section class="indent-1">
        <section style="width: 10%">
            <div class="vertical-menu">
                ...
                $query = "SELECT * FROM challengeaudit";
...
if (isset($_POST['start'])){
    ...
    if (isset($_POST['subject'])) {
        if (isset($_POST['content'])) {
            ...
            $query = mysqli_query($conn, "INSERT INTO challengeaudit(content, subject) VALUES ('$content', '$subject')");
            if ($query) {
            } else {
...
if (isset($_POST['name'])){
    if (isset($_POST['subject'])) {
        if (isset($_POST['content'])) {
            ...
            $query = mysqli_query($conn, "UPDATE challengeaudit SET subject = ".$content.", content = ".$subject." ");
            if ($query) {
            } else {
                echo "ERROR WHILE INSERTING";
            }
