...
if (isset($_POST['start'])){
    ...
    if (isset($_POST['subject'])) {
        if (isset($_POST['content'])) {
            ...
            $query = mysqli_query($conn, "INSERT INTO blog(content, subject) VALUES ('$content', '$subject')");
            if ($query) {
            } else {
...
if (isset($_POST['name'])){
    if (isset($_POST['subject'])) {
        if (isset($_POST['content'])) {
            ...
            $query = mysqli_query($conn, "UPDATE blog SET subject = ".$content.", content = ".$subject." ");
            if ($query) {
            } else {
                echo "ERROR WHILE INSERTING";
            }
