...
$queryInfo = "SELECT * FROM information WHERE blogSub = 1";
$queryCron = "SELECT * FROM blogCron";
$queryMail = "SELECT * FROM blogMail";
$queryEvents = "SELECT * FROM blogEvents";
echo "<h1>SendMail</h1>";
                                                    ...
                                                    if (mysqli_num_rows($resultMail) > 0) {
                                                        while ($rowMail = mysqli_fetch_assoc($resultMail)) {
                                                            ...
                                                            if ($rowCron['event'] == $rowMail['evento']) {
                                                                ...
                                                                if ($rowInfo['blogCounter'] == $rowMail['id']) {
                                                                    ...
                                                                    for ($k = 0; $k < sizeof($emailsArray); $k++) {
                                                                        try {
                                                                            ...
                                                                            $queryCounter = "UPDATE information SET blogCounter = " . $rowInfo['blogCounter'] . "+1 WHERE " . $rowInfo['blogCounter'] . " = " . $rowMail['id'] . " ";
                                                                            if ($mail->send()) {
                                                                            } else {
                                                                                echo $mail->ErrorInfo;
                                                                            }
                                                                    ...
                                                                    $queryRecords = "INSERT INTO blogRecords (timeInserted, subject, content, sendFrom, sendTo) VALUES (NOW(), '" . $rowMail['subject'] . "','" . $rowMail['content'] . "', '" . $rowCron['emails'] . "','" . $emailsInfoArray . "')";
